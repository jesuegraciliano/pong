window.onload = () => {
  ...
  function drawScore(p1, p2) {
    ...
    context.fillText(p1, canvas.width / 4, 50);
    context.fillText(p2, 3 * canvas.width / 4, 50);
  }
  ...
  playButton.addEventListener('click', () => {
    ...
    music.play().then(() => {
      ...
      console.warn("Navegador bloqueou o áudio até uma interação real do usuário:", err);
    });
  });
};
